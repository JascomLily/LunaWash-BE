...
namespace LunaWash.BLL.Services
{
    public class BookingService : IBookingService
    {
        ...
        public async Task<IEnumerable<BookingResponseDTO>> GetUserBookingsAsync(string userId)
        {
            ...
            return bookings.Select(b => BuildBookingResponse(b, reviews.FirstOrDefault(r => r.BookingId == b.Id)));
        }
        ...
        public async Task<IEnumerable<BookingResponseDTO>> GetTodayBookingsForStaffAsync(string branchId)
        {
            ...
            return bookings.Select(b => BuildBookingResponse(b));
        }
        ...
        private BookingResponseDTO BuildBookingResponse(Booking b, ServiceReview? review = null)
        {
            string packageName = "Gói Cơ Bản";
            string services = "";
            string extras = "";
